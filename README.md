...
- **Local Offline Text-To-Speech (TTS)**: Uses system voice engines (macOS `say`, Windows `SAPI5`, Linux `espeak` / Web Speech API) — zero cloud API keys required.
...
- **Wake Word & Voice Commands**: Continuous listening for "Martha" with interactive visual orb UI and local Web Audio synthesized sound chimes.
