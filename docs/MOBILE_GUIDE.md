...
### Method 1: Instant Progressive Web App (PWA) — Recommended ⭐️
...
1. Open the Martha URL (e.g. `http://<YOUR_PC_IP>:8000` or your hosted URL) in **Chrome**.
2. Tap the **"Install App"** prompt banner at the bottom, or tap the three dots **(⋮)** in the top-right and select **"Install app"** (or *"Add to Home screen"*).
...
2. Tap the **Share** button <i class="fa-solid fa-arrow-up-from-bracket"></i> in the bottom toolbar.
